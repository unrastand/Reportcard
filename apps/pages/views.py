...
from apps.academics.models import Department, Semester, AcademicSession, Subject, Batch
from apps.result.models import SubjectGroup
from apps.students.forms import StudentForm
from apps.students.models import AdmissionStudent
from apps.articles.models import Article
from apps.students.tasks import send_admission_confirmation_email
