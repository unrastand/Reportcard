from apps.academics.constants import AcademicsURLConstants
from apps.accounts.constants import AccountURLConstants
from apps.accounts.services.menu import MenuService
from apps.accounts.utils.menu_config import get_menu_config
from apps.institute.models import (
    InstituteProfile,
    TextWidget,
    ListWidget,
)
